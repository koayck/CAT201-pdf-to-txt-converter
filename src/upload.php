...
<?php
    if (isset($_FILES['pdfFile']['name'])) {
        $inputPath = "/home/yicheng/CAT201/pdf-to-text/input/" . $_FILES['pdfFile']['name'];
        $outputPath = "/home/yicheng/CAT201/pdf-to-text/output/";
        $outputFile = "/home/yicheng/CAT201/pdf-to-text/output/output.txt";

        // Move uploaded file to uploads directory
        move_uploaded_file($_FILES['pdfFile']['tmp_name'], $inputPath);

        $executeCommand = "java -cp /home/yicheng/CAT201/pdf-to-text/lib/pdfbox-app-3.0.1.jar:/home/yicheng/CAT201/pdf-to-text/bin/ ConvertPDF " . $inputPath . " " . $outputPath;
